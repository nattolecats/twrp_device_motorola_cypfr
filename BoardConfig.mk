...
TARGET_KERNEL_CONFIG := cypfr_defconfig
TARGET_KERNEL_SOURCE := kernel/motorola/cypfr
...
# Kernel modules
PRODUCT_COPY_FILES += \
    $(call find-copy-subdir-files,*,$(DEVICE_PATH)/prebuilt/modules/,$(TARGET_COPY_OUT_RAMDISK)/lib/modules)
